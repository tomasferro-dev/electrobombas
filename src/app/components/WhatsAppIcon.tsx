...
/**
 * Ícono de WhatsApp como SVG inline.
 *
 * Reemplaza a react-icons, que se instalaba entera para usar este único
 * glifo y convivía con lucide-react haciendo lo mismo. El path es el
 * oficial de Font Awesome (whatsapp, licencia CC BY 4.0).
 */
