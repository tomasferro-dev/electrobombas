...
export const PRODUCTOS_VENTA: ProductoVenta[] = [
  ...
  },
  {
    ...
    tipo: 'Hidráulica',
    marca: 'Franklin Electric',
    modelo: 'FPS / Multistage',
    descripcion:
      'Cuerpo hidráulico multiestátor que se acopla directamente al motor Franklin Electric. Fabricado en acero inoxidable con impulsores de alta eficiencia. Disponible en un rango de potencias que cubre desde aplicaciones domiciliarias hasta industriales de gran escala.',
    specs: [
